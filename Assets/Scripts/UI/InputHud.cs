...
namespace UI
{
    public class InputHud : MonoBehaviour
    {
        ...
        private void CalculateAim()
        {
            ...
            var invertYaw = actionYaw.action.bindings[_yawIndex].overrideProcessors.Length > 2;
            var invertThrottle = actionThrottle.action.bindings[_throttleIndex].overrideProcessors.Length > 2;
            var invertRoll = actionRoll.action.bindings[_rollIndex].overrideProcessors.Length > 2;
            var invertPitch = actionPitch.action.bindings[_pitchIndex].overrideProcessors.Length > 2;
            ...
            var invertPitch2 = InputSystem.devices.IndexOf(
                d => d.device.displayName.Contains("beta", StringComparison.OrdinalIgnoreCase)) != -1;
